...
<!-- Mirrored from www.ansonika.com/foogra/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Jul 2023 07:08:55 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="RuachR Easybuy EasyRent">
    <meta name="author" content="RuachR Easybuy EasyRent">
    <title>RUACHR - Account</title>
...
<body>
	...
	<header class="header_in clearfix element_to_stick">
		...
		<div id="logo">
			<a href="index-2.html">
				<img src="{{asset('images/logo-inverse.png')}}" width="35" height="50" alt="" class="logo_normal">
				<img src="{{asset('images/logo.png')}}" width="35" height="50" alt="" class="logo_sticky">
			</a>
		</div>
		<ul id="top_menu">
			<li><a href="/signin" id="sign-in" class="login">Sign In</a></li>
			...
			<ul>
				<li class="submenu">
					...
					<ul>
						...
						<li><a href="index-17.html">GDPR Cookie Bar EU Law</a></li>
					</ul>
				</li>
				<li class="submenu">
				...
				<li><a href="/signup" target="_parent">Signup</a></li>
			</ul>
		</nav>
	</div>
	</header>
...
<!-- Mirrored from www.ansonika.com/foogra/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Jul 2023 07:09:46 GMT -->
</html>